...
import CustomDisclosure from "./Disclosure"; // Assuming you have a separate Disclosure component
...
function Sidebar({ mobileFiltersOpen, setMobileFiltersOpen, sort, setSort }) {
  const getHeaderText = () => {
  ...
  return (
    <div className="bg-scorpion-50">
      ...
      <div className="flex items-baseline justify-between mx-auto max-w-7xl px-2 sm:px-3 lg:px-4 border-b border-scorpion-200 py-4">
